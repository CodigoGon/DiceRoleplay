        ...
        if (world.capturedBlockStates.size() > 0) {
            ...
            if (!event.isCancelled()) {
                for (BlockState blockstate : blocks) {
                    ...
                    world.checkCapturedTreeStateForObserverNotify(this.position, (org.bukkit.craftbukkit.v1_20_R1.block.CraftBlockState) blockstate); // Paper - notify observers even if grow failed
                }
            }
        }
