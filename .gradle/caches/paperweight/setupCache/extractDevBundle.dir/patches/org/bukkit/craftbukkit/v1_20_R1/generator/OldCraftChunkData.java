...
public final class OldCraftChunkData implements ChunkGenerator.ChunkData {
    ...
    private LevelChunkSection getChunkSection(int y, boolean create) {
        ...
        if (create && section == null) {
            this.sections[offset] = section = new LevelChunkSection(this.biomes, this.world instanceof org.bukkit.craftbukkit.v1_20_R1.CraftWorld ? ((org.bukkit.craftbukkit.v1_20_R1.CraftWorld) this.world).getHandle() : null, null, offset + (this.minHeight >> 4)); // Paper - Anti-Xray - Add parameters
        }
        return section;
    }
